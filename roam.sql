...
--
-- Machine: 127.0.0.1
-- Gegenereerd op: 29 mei 2015 om 13:46
-- Serverversie: 5.6.17
-- PHP-versie: 5.5.12
...
--
-- Tabelstructuur voor tabel `profiel_posts`
--

CREATE TABLE IF NOT EXISTS `profiel_posts` (
...
--
-- Tabelstructuur voor tabel `profiel_reviews`
--

CREATE TABLE IF NOT EXISTS `profiel_reviews` (
  `row_ID` int(11) NOT NULL AUTO_INCREMENT,
  `profiel_ID` int(11) NOT NULL,
...
--
-- Beperkingen voor tabel `profiel_posts`
--
ALTER TABLE `profiel_posts`
  ADD CONSTRAINT `profiel_posts_ibfk_1` FOREIGN KEY (`profiel_ID`) REFERENCES `profiel` (`profiel_ID`),
  ADD CONSTRAINT `profiel_posts_ibfk_2` FOREIGN KEY (`post_ID`) REFERENCES `posts` (`post_ID`);

--
-- Beperkingen voor tabel `profiel_reviews`
--
ALTER TABLE `profiel_reviews`
  ADD CONSTRAINT `profiel_reviews_ibfk_1` FOREIGN KEY (`profiel_ID`) REFERENCES `profiel` (`profiel_ID`),
  ADD CONSTRAINT `profiel_reviews_ibfk_2` FOREIGN KEY (`review_ID`) REFERENCES `reviews` (`review_ID`);
